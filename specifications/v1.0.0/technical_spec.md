...
```markdown
## **Title: [Design] 사용자 인증 전체 플로우 UI/UX 설계**
...
```markdown
## **Title: [Design] AI 기반 백로그 정의 플로우 UI/UX 설계**
...
```markdown
## **Title: [Design] 스토리 포인트 할당 및 AI 작업 분할 제안 UI 설계**
...
```markdown
## **Title: [Design] 스프린트 계획 및 칸반 보드 UI 설계**
...
```markdown
## **Title: [Design] 스프린트 마감 및 회고 유도 UI 설계**
...
```markdown
## **Title: [Design] AI 회고 대화 및 KPT 리포트 UI 설계**
...
```markdown
## **Title: [Design] AI 기능 일일 사용량 제한 안내 UI 설계**

**Body:**

### **User Story (Why)**

- 사용자는 서비스 정책에 따라 기능 사용이 제한될 경우, 그 이유를 명확하고 친절하게 안내받고 싶어한다.

### **To-Do (What)**

- AI 기능의 일일 사용 횟수를 모두 소진했을 때 사용자에게 보여줄 안내 메시지 UI(예: 토스트, 모달)를 디자인합니다.
...
```markdown
## **Title: [Backend] 회원가입 및 이메일 인증 API 구현**
...
- **PRD Reference:** 2. MVP 정의
- **Tech Spec Reference:** Feature 0.1
- **선행 작업:** `DO-01`
```
...
```markdown
## **Title: [Backend] JWT 기반 로그인 및 세션 갱신 API 구현**
...
```markdown
## **Title: [Backend] AI 백로그 구체화를 위한 스트리밍 및 CRUD API 구현**
...
```markdown
## **Title: [Backend] 스토리 포인트 할당 및 AI 작업 분할 제안 API 구현**
...
- 백로그에 스토리 포인트와 '추정 근거(선택 사항)'를 저장하는 API를 구현합니다. (DB 모델 변경 포함)
...
```markdown
## **Title: [Backend] 스프린트 계획/실행 API 및 '주간 환산 벨로시티' API 구현**
...
```markdown
## **Title: [Backend] 스프린트 마감 API 및 스케줄링 작업 구현**
...
```markdown
## **Title: [Backend] AI 회고 시작 및 요약 API 구현**
...
```markdown
## **Title: [Backend] LLM 사용량 제한 로직 구현**
...
```markdown
## **Title: [DevOps] 이메일 발송을 위한 AWS SES 구성**
